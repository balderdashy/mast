	...
	*/
	interpretShorthand: function (command) {
		...
		if (_.isFunction(command)) {
			...
			var matches = null, attribute, value;
			...
			// If command has been translated into a function, bind it to *this*
			command = _.isFunction(command) ? _.bind(command,this) : command;

			// Otherwise just return the string and backbone will do the work later
			return command;
		}
	},
