...
Mast.Component = 
{
	...
	initialize: function(attributes,modelAttributes,dontRender){
		...
		// Map shorthand
		this.events = _.objMap(this.events,Mast.mixins.interpretShorthand,this);
		this.bindings = _.objMap(this.bindings,Mast.mixins.interpretShorthand,this);
		this.subscriptions = _.objMap(this.subscriptions,Mast.mixins.interpretShorthand,this);
	},
