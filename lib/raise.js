...
Framework.raise = function (options, cb) {
	...
	if (options.log) {
		...
		Framework.verbose = Framework.verbose ? options.log.verbose : function () {};
	}
	else {
		Framework.log = Framework.isProduction ? function () {} : console && console.log && console.log.bind(console);
		Framework.warn = Framework.isProduction ? function () {} : console && console.warn && console.warn.bind(console);
		Framework.error = Framework.isProduction ? function () {} : console && console.error && console.error.bind(console);
		Framework.debug = Framework.debug ? console && console.debug && console.debug.bind(console) : function () {};
		Framework.verbose = Framework.verbose ? console && console.log && console.log.bind(console) : function () {};
	}
	...
	if (options.log && options.log.level) {
		...
		switch ( options.log.level ) {
			case 'info': Framework.verbose = noop; break;
			case 'warn': Framework.verbose = Framework.debug = Framework.log = noop; break;
			case 'error': Framework.verbose = Framework.debug = Framework.log = Framework.warn = noop;
		}
	}
