...
Framework.raise = function (options, cb) {
	...
	Framework.ready(function () {
		...
		defaultRegions.each(function(i,el) {
			...
			var Component = Framework.components[componentId];
			if (!Component) {
				throw new Error(componentId + ' :: Unknown component!');
			}

			// Instantiate a top-level component
			// (i.e. there is not actually a true region object, just an outlet)
