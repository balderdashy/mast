...
/**
 * Run HTML template through engine and append results to outlet. Also rereder regions.
 ...
 *
 * @param  {number} atIndex Position to render component relative to neighbors
 */
