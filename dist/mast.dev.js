...
Framework = function(options) {
	...
	// its attributes. We will make `FRAMEWORK` accessible via closure scope by wrapping everything
	// in a function.
	FRAMEWORK = this;
